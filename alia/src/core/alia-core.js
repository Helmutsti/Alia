...
export const ALIA_OPERATIONS = [
  ...
  "addTaskTag",
  "removeTaskTag",
  /* Preferenze: il posto dove Alia ricorda come vuoi lavorare. Chiave-valore,
     perche' una preferenza nuova non deve costare una migrazione. */
  "getSetting",
  "setSetting",
  "listSettings",
  "removeSettings",
...
export function createAliaCore({ databasePath }) {
  ...
  return {
    ...
    setSetting: (chiave, valore) => setSetting(database, chiave, valore),
    removeSettings: (prefisso) => removeSettings(database, prefisso),
